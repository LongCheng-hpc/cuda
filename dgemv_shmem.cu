...
int main(int argc, char ** argv) {
	...
	blockX = 1024;	//TODO: Select the number of threads per block
	blockY = 1;
    blockZ = 1;
	...
	gridX = 256;	//TODO: Select the number of blocks
	gridY = 1; 
	gridZ = 1;
	numBlock = {gridX, gridY, gridZ};
	// compose the data into one threadd and multiply it
